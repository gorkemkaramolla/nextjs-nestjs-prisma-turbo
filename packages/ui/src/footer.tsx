...
const socials = [
  {
    name: 'Twitter',
    icon: Twitter,
    href: 'https://twitter.com/dijimall',
  },
  {
    name: 'LinkedIn',
    icon: LinkedIn,
    href: 'https://www.linkedin.com/company/dijimall',
  },
  {
    name: 'GitHub',
    icon: Github,
    href: 'https://github.com/dijimall/dijimall',
  },
  {
    name: 'YouTube',
    icon: YouTube,
    href: 'https://www.youtube.com/@dijimall',
  },
];
...
const navigation = {
  ...
  resources: [
    ...
    {
      name: 'Affiliates',
      href: 'https://partners.dijimall.com',
      target: '_blank',
    },
  ],
  company: [
...
export function Footer({
  ...
  let { domain = 'dijimall.com' } = useParams() as { domain: string };
  if (staticDomain) {
    domain = staticDomain;
  }
    ...
    >
      <footer>
        ...
        <div className="mt-12 grid grid-cols-1 items-center gap-8 sm:grid-cols-2">
          ...
          >
            <Image
              src="https://assets.dijimall.com/misc/soc2.svg"
