import { capitalize, cn } from '@repo/utils';
...
const CUSTOMER = {
  ...
  email: 'gorkemkaramolla@dijimall.com',
  avatarIndex: 8,
  origin: 'dijimall',
  country: 'US',
  details: {
  ...
  return (
    <div className={cn('pointer-events-none relative size-full', className)}>
      <svg
        ...
        fill="none"
        viewBox="0 0 339 168"
        className="h-auto w-full mask-[linear-gradient(90deg,transparent,black_10%,black_90%,transparent)]"
      >
        <path
          stroke="#00BBA7"
          strokeWidth="2"
