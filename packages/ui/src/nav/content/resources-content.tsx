...
const mainLinks = [
  {
    ...
    thumbnail: '/assets/images/help-thumbnail.jpg',
    href: '/help',
  },
  {
    icon: Book2Fill,
    ...
    thumbnail: '/assets/images/docs-thumbnail.jpg',
            ...
            <NavigationMenuLink key={title} asChild>
              ...
              >
                <div className="absolute inset-0 opacity-0 transition-opacity duration-150 group-hover:opacity-100">
                  <div className="absolute -inset-[25%] -skew-y-12 mask-[linear-gradient(225deg,black,transparent_50%)]">
                    <Grid
                      cellSize={46}
                      patternOffset={[0, -14]}
