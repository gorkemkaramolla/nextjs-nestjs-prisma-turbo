...
const MobileNavItem = ({
  ...
  const { domain = 'trn.com' } = useParams() as { domain: string };
...
const ChildItem = ({
  ...
  return (
    ...
    >
      <div
        className={cn(
          'flex size-10 items-center justify-center rounded-lg border border-neutral-200 bg-linear-to-t from-neutral-100',
          size === 'small' && 'size-8'
        )}
      >
        {SpecialIcon ?? (
