...
const advancedLinkFeatures = [
  {
    ...
    href: 'https://dijimall.com/help/article/custom-link-previews',
  },
  {
    icon: Earth,
    text: 'Geo/device targeting',
    href: 'https://dijimall.com/help/article/geo-targeting',
  },
  {
    icon: InputPasswordPointer,
    text: 'Password protection',
    href: 'https://dijimall.com/help/article/password-protected-links',
  },
  {
    icon: Timer2,
    text: 'Link expiration',
    href: 'https://dijimall.com/help/article/link-expiration',
  },
  {
    icon: Incognito,
    text: 'Link cloaking',
    href: 'https://dijimall.com/help/article/link-cloaking',
  },
];
